...
const fn ansi_term_color(color: &kanagawa::Color) -> ansi_term::Colour {
    ansi_term::Colour::RGB(color.rgb.r, color.rgb.g, color.rgb.b)
}
const fn ansi_term_ansi_color(color: &kanagawa::AnsiColor) -> ansi_term::Colour {
    ansi_term::Colour::RGB(color.rgb.r, color.rgb.g, color.rgb.b)
}
    ...
    for flavor in &PALETTE {
        ...
        for ansi_color_pair in &flavor.ansi_colors.to_ansi_color_pairs() {
            println!(
                ...
                ansi_term_ansi_color(&ansi_color_pair.bright).reverse().paint("  "),

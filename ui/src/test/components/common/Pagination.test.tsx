...
describe('Pagination', () => {
  it('renders nothing when there is only 1 page', () => {
    const { container } = render(
      <Pagination page={1} totalPages={1} totalItems={5} pageSize={20} onPageChange={vi.fn()} />,
    )
  ...
  it('renders page buttons for multiple pages', () => {
    render(
      <Pagination page={1} totalPages={3} totalItems={60} pageSize={20} onPageChange={vi.fn()} />,
    )
  ...
  it('marks current page with aria-current', () => {
    render(
      <Pagination page={2} totalPages={3} totalItems={60} pageSize={20} onPageChange={vi.fn()} />,
    )
  ...
  it('disables next button on last page', () => {
    render(
      <Pagination page={3} totalPages={3} totalItems={60} pageSize={20} onPageChange={vi.fn()} />,
    )
  ...
  it('shows item range text', () => {
    render(
      <Pagination page={2} totalPages={3} totalItems={55} pageSize={20} onPageChange={vi.fn()} />,
    )
    // Items 21–40 of 55

...
describe("CheckControls", () => {
	...
	it("shows error message when triggerError is set", () => {
		render(
			<CheckControls {...DEFAULT_PROPS} triggerError="Connection refused" />,
		);
	...
	it("calls onSetAutoTrigger when toggle clicked", () => {
		...
		render(
			<CheckControls {...DEFAULT_PROPS} onSetAutoTrigger={onSetAutoTrigger} />,
		);
	...
	it("shows interval picker when auto-trigger is on", () => {
		...
		expect(
			screen.getByRole("group", { name: "Auto-trigger interval" }),
		).toBeTruthy();
	});
	...
	it("does not show interval picker when auto-trigger is off", () => {
		...
		expect(
			screen.queryByRole("group", { name: "Auto-trigger interval" }),
		).toBeNull();
	});

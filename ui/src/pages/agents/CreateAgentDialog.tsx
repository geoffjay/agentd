...
function buildRequest(form: FormState): CreateAgentRequest {
	...
	return {
		...
		auto_clear_threshold:
			parsedThreshold && parsedThreshold > 0 ? parsedThreshold : undefined,
	};
}
...
export function CreateAgentDialog({
	...
	const showToolList =
		form.tool_policy_type === "allow_list" ||
								...
								>
									...
									<div>
										<div className="flex items-center justify-between">
											<div className="flex-1 pr-4">
												...
												<span className="mt-0.5 block text-xs text-th-text-faint">
													...
													Cost tracking and tool policies are unavailable in
													this mode.
												</span>
											</div>
											<button
										...
										{form.interactive && (
											...
											>
												...
												/>
												<span>
													Interactive mode enabled. Cost tracking and tool
													policies will not be available for this agent. The
													initial prompt field is also disabled.
												</span>
											</div>
										)}
									</div>
									...
									<div>
										...
										<input
											...
											onChange={(e) =>
												update("auto_clear_threshold", e.target.value)
											}

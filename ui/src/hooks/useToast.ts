...
export interface UseToastReturn {
	success: (
		title: string,
		options?: { message?: string; action?: ToastAction },
	) => string;
	error: (
		title: string,
		options?: { message?: string; action?: ToastAction; duration?: number },
	) => string;
	warning: (
		title: string,
		options?: { message?: string; action?: ToastAction },
...
export function useToast(): UseToastReturn {
	return {
		success: (title, options) => toastStore.success(title, options),
		error: (title, options) => toastStore.error(title, options),
		warning: (title, options) => toastStore.warning(title, options),
		info: (title, options) => toastStore.info(title, options),

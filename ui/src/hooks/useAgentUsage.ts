...
function applyUsageUpdate(
	...
	const currentSession = prev.current_session
		? {
				...
				output_tokens:
					prev.current_session.output_tokens + snapshot.output_tokens,
				cache_read_input_tokens:
					prev.current_session.cache_read_input_tokens +
				...
				total_cost_usd:
					prev.current_session.total_cost_usd + snapshot.total_cost_usd,
				...
				duration_api_ms:
					prev.current_session.duration_api_ms + snapshot.duration_api_ms,
	...
	return {
		...
		cumulative: {
			...
			cache_read_input_tokens:
				prev.cumulative.cache_read_input_tokens +
				snapshot.cache_read_input_tokens,
			cache_creation_input_tokens:
				prev.cumulative.cache_creation_input_tokens +
				snapshot.cache_creation_input_tokens,
			...
			duration_api_ms:
				prev.cumulative.duration_api_ms + snapshot.duration_api_ms,
